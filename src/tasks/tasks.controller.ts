...
export class TasksController {
  ...
  findAll(@Req() req: any, @Param('projectId') projectId: string, @Query() filter: FilterTaskDto) {
  ...
  assignUser(@Req() req: any, @Param('taskId') taskId: string, @Body() dto: AssignTaskDto) {
  ...
  unassignUser(@Req() req: any, @Param('taskId') taskId: string, @Param('userId') userId: string) {
